...
public class Constants {
	...
	public static final String MR_MAP_JAVA_OPTS = "mapred.map.child.java.opts";
	public static final String MR_RED_JAVA_OPTS = "mapred.reduce.child.java.opts";
	...
	public static final String MR_OLD_COMBINER_CLASS = "mapred.combiner.class";
	...
	public static final String MR_OUT_COMPRESS_CODEC = "mapred.output.compression.codec";
	public static final String MR_OLD_INPUT_FORMAT_CLASS = "mapred.input.format.class";
	public static final String MR_OLD_SFIF = "org.apache.hadoop.mapred.SequenceFileInputFormat";
	public static final String MR_OLD_TIF = "org.apache.hadoop.mapred.TextInputFormat";
	...
	public static final String MR_OLD_OUTPUT_FORMAT_CLASS = "mapred.output.format.class";
	public static final String MR_OLD_SFOF = "org.apache.hadoop.mapred.SequenceFileOutputFormat";
	public static final String MR_OLD_TOF = "org.apache.hadoop.mapred.TextOutputFormat";
	...
	public static final String MR_MAPPER_NEW_API = "mapred.mapper.new-api";
	public static final String MR_REDUCER_NEW_API = "mapred.reducer.new-api";
	...
	public static final long DEF_TASK_MEM = 209715200L;
	...
	public static final float DEF_RED_IN_BUFF_PERC = 0.0F;
	public static final float DEF_RED_SLOWSTART_MAPS = 0.05F;
	public static final long DEF_SPLIT_SIZE = 67108864L;
	public static final long DEF_MAX_UNIQUE_GROUPS = 1L;
	public static final double DEF_PAIR_WIDTH = 100.0D;
	public static final double DEF_RED_PAIRS_PER_GROUP = 1.0D;
	public static final double DEF_SEL_ONE = 1.0D;
	public static final double DEF_COMPRESS_RATIO = 0.3D;
	public static final double DEF_MEM = 10485760.0D;
	public static final double DEF_MEM_PER_REC = 100.0D;
	public static final double DEF_COST_CPU_UNCOMPRESS = 100.0D;
	public static final double DEF_COST_CPU_COMPRESS = 150.0D;
	public static final double DEF_COST_CPU_COMBINE = 4000.0D;
	public static final String STARFISH_USE_COMBINER = "starfish.use.combiner";
	public static final double NS_PER_MS = 1000000.0D;
}